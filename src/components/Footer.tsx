    ...
    <footer className="bg-white border-t mt-auto">
      <div className="mx-auto max-w-7xl px-6 py-6 md:flex md:items-center md:justify-between lg:px-8">
        ...
        <div className="flex justify-center space-x-6 md:order-2 mt-4 md:mt-0">
          <a href="https://www.facebook.com/share/1ACm71UpPp/" className="text-gray-900 hover:text-gray-500">
          ...
          <a href="https://www.instagram.com/chitralai.in?igsh=MXA2ZHQ5MTE2Y3V5MQ==" className="text-gray-900 hover:text-gray-500">
          ...
          <a href="https://youtube.com/@chitralai-in?si=f1WG8THy3-LUqEHA" className="text-gray-900 hover:text-gray-500">
          ...
          <a href="https://www.linkedin.com/company/chitralai/posts/?feedView=all" className="text-gray-900 hover:text-gray-500">
